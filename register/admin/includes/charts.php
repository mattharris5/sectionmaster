...
//====================================
function InsertSMChart($php_source, $width=400, $height=250, $bg_color="666666", $transparent=false) {
	return InsertChart("includes/charts.swf", "includes/charts_library", $php_source, $width, $height, $bg_color, $transparent);
}
