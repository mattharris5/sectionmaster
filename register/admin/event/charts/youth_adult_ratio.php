...
# issue query
$sql = "SELECT SUM(youth) AS youth_count, SUM(adult) AS adult_count 
...
$chart['chart_data'][0][1] = "Youth";
$chart['chart_data'][1][1] = "$count->youth_count";
$chart['chart_data'][0][2] = "Adult";
$chart['chart_data'][1][2] = "$count->adult_count";
