...
class PHPExcel_Calculation_Functions {
	 ...
	 * @return	float
	 *
	 * gdp@todo	Cumulative distribution function
	 *
	 */
	 ...
	 * @return	int
	 *
	 *	gdp@todo	Warning. This implementation differs from the algorithm detailed on the MS
...
//		$rMax			= self::flattenSingleValue($rMax);
	 ...
	 * @return	float
	 *
	 * gdp@todo	Try implementing P J Acklam's refinement algorithm for greater
...
//			Sometimes we need to add 1, sometimes not. I haven't yet worked out the rule which determines this.
	...
	*/
	public static function VLOOKUP($lookup_value, $lookup_array, $index_number, $not_exact_match=true) {
		...
		// gdpTODO: The VLOOKUP spec in Excel states that, at this point, we should search for
	...
	public static function LOOKUP($lookup_value, $lookup_vector, $result_vector=null) {
		...
		// Syntax 1 (vector)
			...
			if( isset($result_vector[$kr][$k_res]) )
			{
				...
				// gdpTODO: In Excel Documentation is not clear what happen here...
			}
		}
 	}	//	function LOOKUP()
